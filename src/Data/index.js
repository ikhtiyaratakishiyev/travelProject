...
import img1_1 from '../Assets/Images/img1_1.jpg'
import img1_2 from '../Assets/Images/img1_2.jpg'
import img1_3 from '../Assets/Images/img1_3.jpg'
import img2_1 from '../Assets/Images/img2_1.jpg'
import img2_2 from '../Assets/Images/img2_2.jpg'
import img2_3 from '../Assets/Images/img2_3.jpg'
import img3_1 from '../Assets/Images/img3_1.jpg'
import img3_2 from '../Assets/Images/img3_2.jpg'
import img3_3 from '../Assets/Images/img3_3.jpg'
import img4_1 from '../Assets/Images/img4_1.jpg'
import img4_2 from '../Assets/Images/img4_2.jpg'
import img4_3 from '../Assets/Images/img4_3.jpg'
import img5_1 from '../Assets/Images/img5_1.jpg'
import img5_2 from '../Assets/Images/img5_2.jpg'
import img5_3 from '../Assets/Images/img5_3.jpg'
import img6_1 from '../Assets/Images/img6_1.jpg'
import img6_2 from '../Assets/Images/img6_2.jpg'
import img6_3 from '../Assets/Images/img6_3.jpg'
import img7_1 from '../Assets/Images/img7_1.jpg'
import img7_2 from '../Assets/Images/img7_2.jpg'
import img7_3 from '../Assets/Images/img7_3.jpg'
import img8_1 from '../Assets/Images/img8_1.jpg'
import img8_2 from '../Assets/Images/img8_2.jpg'
import img8_3 from '../Assets/Images/img8_3.jpg'
import img9_1 from '../Assets/Images/img9_1.jpg'
import img9_2 from '../Assets/Images/img9_2.jpg'
import img9_3 from '../Assets/Images/img9_3.jpg'
import img10_1 from '../Assets/Images/img10_1.jpg'
import img10_2 from '../Assets/Images/img10_2.jpg'
import img10_3 from '../Assets/Images/img10_3.jpg'
import img11_1 from '../Assets/Images/img11_1.jpg'
import img11_2 from '../Assets/Images/img11_2.jpg'
import img11_3 from '../Assets/Images/img11_3.jpg'
import img12_1 from '../Assets/Images/img12_1.jpg'
import img12_2 from '../Assets/Images/img12_2.jpg'
import img12_3 from '../Assets/Images/img12_3.jpg'
...
export const travelData = [
    ...
    },
    {
        ...
        grade: ' Cultural Relax',
        fees: '$1100',
        description: 'Guanajuato  is a municipality in central Mexico and the capital of the state of the same name. It is part of the macroregion of the Bajío.It is located in a narrow valley.'
    },
    {
        id:'6',
        imgSrc:img6,
        ...
        grade: ' Cultural Relax',
        fees: '$840',
        description: 'The Cinque Terre  is a coastal area within Liguria, in the northwest of Italy. It lies in the west of La Spezia Province.'
    },
    {
        id:'7',
        imgSrc:img7,
        ...
        grade: ' Cultural Relax',
        fees: '$790',
        description: 'Angkor Wat  is a temple complex in Cambodia, located on a site measuring 162.6 hectares.'
    },
    {
        id:'8',
        imgSrc:img8,
    ...
    },
    {
        ...
        grade: ' Cultural Relax',
        fees: '$500',
        description: 'Bali is a province of Indonesia and the westernmost of the Lesser Sunda Islands. East of Java and west of Lombok. '
    },
    {
        id:'10',
        imgSrc:img10,
        ...
        grade: ' Cultural Relax',
        fees: '$650',
        description: 'Baku is the capital and largest city of Azerbaijan, as well as the largest city on the Caspian Sea and in the Caucasus region.'
    },
    {
        id:'11',
        imgSrc:img11,
        ...
        grade: ' Cultural Relax',
        fees: '$350',
        description: 'Moscow  is the capital and largest city of Russia. The city stands on the Moskva River in Central Russia.'
    },
    {
        id:'12',
        imgSrc:img12,
        ...
        grade: ' Cultural Relax',
        fees: '$300',
        description: 'Tbilisi is the capital of the country of Georgia. Its cobblestoned old town reflects a long, complicated history.'
    },
...
export const productData =[
    ...
    },
    {
        ...
        grade: ' Cultural Relax',
        fees: '$840',
        description: 'The Cinque Terre (Italian pronunciation: [ˈtʃiŋkwe ˈtɛrre], meaning "Five Lands") is a coastal area within Liguria, in the northwest of Italy. It lies in the west of La Spezia Province, and comprises five villages: Monterosso al Mare, Vernazza, Corniglia, Manarola, and Riomaggiore. The coastline, the five villages, and the surrounding hillsides are all part of the Cinque Terre National Park, a UNESCO World Heritage Site. Vernazza is a member of the I Borghi più belli d`Italia ("The most beautiful villages of Italy") association.[1]The Cinque Terre area is a popular tourist destination. Over the centuries, people have built terraces on the rugged, steep landscape right up to the cliffs that overlook the Ligurian Sea. Paths, trains, and boats connect the villages as cars can only reach them with great difficulty from the outside via narrow and precarious mountain roads.'
    },
    {
        id:'7',
        img1:img7_1,
    ...
    },
    {
        ...
        grade: ' Cultural Relax',
        fees: '$900',
        description: 'The Taj Mahal [4][5][6] is an ivory-white marble mausoleum on the right bank of the river Yamuna in Agra, Uttar Pradesh, India. It was commissioned in 1631 by the fifth Mughal emperor, Shah Jahan (r. 1628–1658) to house the tomb of his beloved wife, Mumtaz Mahal; it also houses the tomb of Shah Jahan himself. The tomb is the centrepiece of a 17-hectare (42-acre) complex, which includes a mosque and a guest house, and is set in formal gardens bounded on three sides by a crenellated wall.Construction of the mausoleum was essentially completed in 1643, but work continued on other phases of the project for another 10 years. The Taj Mahal complex is believed to have been completed in its entirety in 1653 at a cost estimated at the time to be around ₹32 million, which in 2023 would be approximately ₹35 billion.[7] The construction project employed some 20,000 artisans under the guidance of a board of architects led by Ustad Ahmad Lahori, the emperor`s court architect. Various types of symbolism have been employed in the Taj to reflect natural beauty and divinity.The Taj Mahal was designated as a UNESCO World Heritage Site in 1983 for being "the jewel of Muslim art in India and one of the universally admired masterpieces of the world`s heritage". It is regarded by many as the best example of Mughal architecture and a symbol of India`s rich history. The Taj Mahal attracts 7-8 million visitors a year,[8] and in 2007 it was declared a winner of the New 7 Wonders of the World (2000–2007) initiative.'
    },
    {
        id:'9',
        img1:img9_1,
    ...
    },
    {
        ...
        grade: ' Cultural Relax',
        fees: '$350',
        description: 'Moscow (/ˈmɒskoʊ/ MOS-koh, US chiefly /ˈmɒskaʊ/ MOS-kow;[12][13] Russian: Москва, tr. Moskva, IPA: [mɐskˈva] ⓘ) is the capital and largest city of Russia. The city stands on the Moskva River in Central Russia, with a population estimated at 13.0 million residents within the city limits,[6] over 18.8 million residents in the urban area,[7] and over 21.5 million residents in the metropolitan area.[14] The city covers an area of 2,511 square kilometers (970 sq mi), while the urban area covers 5,891 square kilometers (2,275 sq mi),[7] and the metropolitan area covers over 26,000 square kilometers (10,000 sq mi).[14] Moscow is among the world`s largest cities, being the most populous city entirely in Europe, the largest urban and metropolitan area in Europ,and the largest city by land area on the European continent.First documented in 1147, Moscow grew to become a prosperous and powerful city that served as the capital of the Grand Duchy of Moscow. When the Tsardom of Russia was proclaimed, Moscow remained the political and economic center for most of its history. Under the reign of Peter the Great, the Russian capital was moved to the newly founded city of Saint Petersburg in 1712, diminishing Moscow`s influence. Following the Russian Revolution and the establishment of the Russian SFSR, the capital was moved back to Moscow in 1918, where it later became the political center of the Soviet Union.[16] In the aftermath of the dissolution of the Soviet Union, Moscow remained the capital city of the newly established Russian Federation.'
    },
    {
        id:'12',
        img1:img12_1,
